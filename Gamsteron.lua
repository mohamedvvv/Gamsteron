...
-- local classes
local Menu, Color, Action, Buff, Math, Damage, Data, Spell, LevelUp, SummonerSpell, Item, Object, Target, Orbwalker, Cursor, Health, Attack
...
Data = {
    ...
    AttackResets =
    {
        ...
        ['lucian'] = {Slot = _E, Key = HK_E, OnCast = true, CanCancel = true},-- Buff = 'LucianPassiveBuff', 
...
Menu:Init()
if Menu.LevelUpLoaded then LevelUp:Init() end
Action:Init()
Object:Init()
Target:Init()
Orbwalker:Init()
if Menu.SummonerSpellsLoaded then SummonerSpell:Init() end
if Menu.ItemsLoaded then Item:Init() end
Buff:Init()
Damage:Init()
Cursor:Init()
Health:Init()
